...
class NetworkNormalizer:
    NETWORKS: dict[str, tuple[str, int | None, str]] = {
        ...
        "algorand": ("algorand", None, "algorand"),
        "aurora": ("aurora", 1313161554, "evm"),
        "base": ("base", 8453, "evm"),
        ...
        "hyperliquid": ("hyperliquid", None, "evm"),
        ...
        "merlin": ("merlin", None, "evm"),
        "monad": ("monad", None, "evm"),
        "morph": ("morph", None, "evm"),
        "plasma": ("plasma", None, "evm"),
        "scroll": ("scroll", 534352, "evm"),
        "sei": ("sei", None, "evm"),
        "sei evm": ("sei-evm", None, "evm"),
        "sonic": ("sonic", None, "evm"),
        "taiko": ("taiko", 167000, "evm"),
        "unichain": ("unichain", 130, "evm"),
        "xdc": ("xdc", 50, "evm"),
        "zircuit": ("zircuit", None, "evm"),
        "zklink nova": ("zklink-nova", None, "evm"),
        ...
        "statemint": ("statemint", None, "substrate"),
        "xrp": ("xrp", None, "xrp"),
        "ripple": ("xrp", None, "xrp"),
        "xrp ledger": ("xrp", None, "xrp"),
        "ton": ("ton", None, "ton"),
        "tezos": ("tezos", None, "tezos"),
        "bera": ("bera", None, "evm"),
